...
def main(args):
    ...
    train_dataset = eval(args.dataloader)(args.img_dir, args.cv_num, args.seed, args.shot)
...
def parse_args():
    ...
    parser.add_argument(
        "--dataloader", help="data loader", default="FrameOrderFlippingAlphaBrendingPastingLoader", type=str
    )
